...
public struct ABIEncoder {
    ...
    public static func convertToData(_ value: Any) -> Data? {
        switch value {
            ...
            case let b as Bool:
                return b ? Data([UInt8(1)]) : Data([UInt8(0)])
            default:
                return nil
        }
    }
...
public extension ABIEncoder {
    ...
    // Rewritten to fix warnings in the original code:
